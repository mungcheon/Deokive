...
class BuildSourceDiscoveryStoreBottlenecksPublicTest(unittest.TestCase):
    def test_build_report_groups_action_rows_by_store(self) -> None:
        ...
        self.assertEqual(report["summary"]["top_5_store_rows"], 3)
        self.assertEqual(report["summary"]["top_5_store_coverage"], 1.0)
        self.assertEqual(report["summary"]["top_10_store_rows"], 3)
        self.assertEqual(report["summary"]["top_10_store_coverage"], 1.0)
        ...
        self.assertEqual(animate["impact_rank_hint"], 2)
        self.assertEqual(animate["first_batch_id"], "b1")
        self.assertEqual(animate["top_allowed_source_domain"], "animate.example")
        self.assertEqual(animate["recommended_work_mode"], "single_store_batch_review")
