...
class BuildAnimationCategoryActionQueuePublicTest(unittest.TestCase):
    def test_build_queue_creates_manual_mapping_templates(self) -> None:
        ...
        self.assertEqual(report["summary"]["queued_categories"], 2)
        self.assertEqual(report["summary"]["queued_catalog_rows"], 105)
        self.assertEqual(report["summary"]["direct_mapping_queued_categories"], 1)
        self.assertEqual(report["summary"]["direct_mapping_queued_catalog_rows"], 97)
        self.assertEqual(report["summary"]["normalization_review_queued_categories"], 1)
        self.assertEqual(report["summary"]["normalization_review_queued_catalog_rows"], 8)
