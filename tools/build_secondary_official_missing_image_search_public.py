...
REPORT = DATA / "secondary_official_missing_image_search_public.json"
...
SEGA_STORE = "SEGA"
TARGET_STORES = (AMIAMI_STORE, COSPA_STORE, BANDAI_STORE, MEGAHOUSE_STORE, REMENT_STORE, SEGA_STORE)
...
def target_catalog_rows(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
...
def build_report(
    ...
    *,
    ...
    rows = target_catalog_rows(catalog_items(catalog))
        ...
        matched_items.append(
            {
                ...
                "import_template": {
                    ...
                    "blocked_until": "exact_official_or_licensed_product_page_confirmed",
                },
            }
        )
    ...
    return {
        ...
        "scope": "secondary_official_missing_image_search",
        "summary": {
        ...
        "automation_policy": {
            ...
            "requires_exact_official_or_licensed_product_page": True,
