...
class BuildSourceDiscoveryActionQueuePublicTest(unittest.TestCase):
    def test_build_report_keeps_actionable_review_states(self) -> None:
        ...
        self.assertEqual(
            ...
            {"official_search_url": 2},
        )
        self.assertEqual(
            report["summary"]["first_primary_review_url"],
            "https://animate.example/search?q=stand",
        )
        self.assertEqual(report["summary"]["first_primary_review_url_kind"], "official_search_url")
        ...
        self.assertEqual(report["source_store_workstreams"][0]["fallback_web_search_url_count"], 0)
        self.assertEqual(
            report["source_store_workstreams"][0]["first_primary_review_url"],
            "https://animate.example/search?q=stand",
        )
        self.assertEqual(
            report["source_store_workstreams"][0]["first_primary_review_url_kind"],
            "official_search_url",
        )
        ...
        self.assertEqual(
            report["source_store_workstreams"][0]["sample_items"][0]["primary_review_url"],
            "https://animate.example/search?q=stand",
        )
        ...
        self.assertEqual(report["batches"][0]["first_primary_review_url_kind"], "official_search_url")
        self.assertEqual(
        ...
        self.assertEqual(flat_template[0]["primary_review_url"], "https://animate.example/search?q=stand")
        self.assertEqual(flat_template[0]["primary_review_url_kind"], "official_search_url")
