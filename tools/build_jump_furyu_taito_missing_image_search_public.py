...
REPORT = DATA / "jump_furyu_taito_missing_image_search_public.json"

JUMP_STORE = "\uc810\ud504 \uce90\ub9ad\ud130\uc988 \uc2a4\ud1a0\uc5b4"
FURYU_STORE = "FuRyu"
TAITO_STORE = "Taito"
TARGET_STORES = (JUMP_STORE, FURYU_STORE, TAITO_STORE)
...
def build_report(
    ...
    *,
        ...
        matched_items.append(
            {
                ...
                "import_template": {
                    ...
                    "blocked_until": "exact_official_or_prize_product_page_confirmed",
                },
            }
        )
    ...
    return {
        ...
        "scope": "jump_furyu_taito_missing_image_search",
        "summary": {
        ...
        "automation_policy": {
            ...
            "requires_exact_official_or_prize_product_page": True,
