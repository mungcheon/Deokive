...
import 'screens/offline_archive_screen.dart';
...
class DeokiveApp extends StatelessWidget {
  ...
  ThemeData _buildTheme({
    ...
    final themedTextTheme = applyAppFont(baseTextTheme, fontFamily)
        .apply(fontFamily: resolvedFamily);
        ...
        builder: (context, appState, _) {
          return LayoutBuilder(
            builder: (context, constraints) {
              ...
              // has saved.
              final beforeLogin = !(appState.isLoggedIn ||
                  appState.inGuestSession ||
                  appState.adminMode);
              final spec = paletteSpecFor(
                  beforeLogin ? AppPalette.zeroTwoPink : appState.appPalette);
              ...
              return MaterialApp(
                ...
                builder: (context, child) {
                  ...
                  final textScale =
                      _textScaleForWidth(width) * appState.fontScale;
                ...
                home: MobileRatioFrame(
                  child: !appState.startupResolved
                      ? const Scaffold(
                          body: Center(
                      ...
                      : (appState.isLoggedIn ||
                              ...
                              appState.adminMode)
                          ? const RootScreen()
                          : appState.canOpenOfflineArchive
                              ? const OfflineArchiveScreen()
                              : const WelcomeScreen(),
                ),
              );
            },
